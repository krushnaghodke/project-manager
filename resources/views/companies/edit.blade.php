            ...
            <div class="col-md-9 col-sm-9 col-lg-9 pull-left">
                <form method="post" action="{{ route('companies.update', [ $company->id ]) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="company_name" name="name" class="form-control" required placeholder="Name" value="{{ $company->name }}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Description</label>
                        <textarea placeholder="Enter Description" name="description" rows="5" class="form-control autosize-target">{{ $company->description }}</textarea>
                    </div>
